...
#' 
#' This function cross-validates \link{coxsplsDR} models.\cr
#' 
...
#' variables passed to \code{\link{coxsplsDR}}'s \code{Xplan} argument,
#' \item\code{time} passed to \code{\link{coxsplsDR}}'s \code{time} argument,
#' \item\code{status} \code{\link{coxsplsDR}}'s \code{status} argument.  }
...
#' @param \dots Other arguments to pass to \code{\link{coxsplsDR}}.
