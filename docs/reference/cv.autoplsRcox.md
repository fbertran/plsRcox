...
models with automatic number of components selection.  
...
- data:
  ...
  - `x` the explanatory variables passed to
    [`plsRcox`](https://fbertran.github.io/plsRcox/reference/plsRcox.md)'s
    `Xplan` argument,
...
#> 
#> $cv.error5
#> [1] 0.5000000 0.9057532 0.8875761 0.9189727
#> 
#> $cv.se5
#> [1] 0.000000000 0.008326560 0.009089276 0.008281982
#> 
#> $folds
#> $folds$`1`
