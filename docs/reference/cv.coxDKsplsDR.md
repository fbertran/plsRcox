...
- data:
  ...
  - `x` the explanatory variables passed to
    [`coxDKsplsDR`](https://fbertran.github.io/plsRcox/reference/coxDKsplsDR.md)'s
    `Xplan` argument,
...
#> 
#> $cv.error10
#> [1] 0.5000000 0.6381540 0.6963262 0.6537039
#> 
#> $cv.se10
#> [1] 0.00000000 0.03036225 0.02912723 0.04020941
#> 
#> $folds
#> $folds$`1`
